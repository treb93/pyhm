    ...
    def __init__(self, data_paths, fixed_params):
        ...
        if fixed_params.discern_clicks:
            self.graph_schema = {('user',
                                  'buys',
                                  'item'): list(zip(self.adjacency_dict['purchases_src'],
                                                    self.adjacency_dict['purchases_dst'])),
                                 ('item',
                                  'bought-by',
                                  'user'): list(zip(self.adjacency_dict['purchases_dst'],
                                                    self.adjacency_dict['purchases_src'])),
                                 ('user',
                                  'clicks',
                                  'item'): list(zip(self.adjacency_dict['clicks_src'],
                                                    self.adjacency_dict['clicks_dst'])),
                                 ('item',
                                  'clicked-by',
                                  'user'): list(zip(self.adjacency_dict['clicks_dst'],
                                                    self.adjacency_dict['clicks_src'])),
                                 }
        else:
            self.graph_schema = {('user',
                                  'buys',
        ...
        if fixed_params.include_sport:
            self.graph_schema.update({('item',
                                       'utilized-for',
                                       'sport'): list(zip(self.adjacency_dict['item_sport_src'],
                                                          self.adjacency_dict['item_sport_dst'])),
                                      ('sport',
                                       'utilizes',
